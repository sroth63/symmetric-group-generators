This repository contains a [Manim](https://www.manim.community/) animation that illustrates that the symmetric group $\mathfrak S_n$ is generated by the following sets:
- The set of transpositions of the form $[1,i]$.
- The set of transpositions of the form $[i,i+1]$.
- The transposition $[1,2]$ and the set $[1,2,\dots,n]$.
